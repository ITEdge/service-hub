...
(defprotocol PEntityHistoryServiceValidator
  ...
  (validate-find-entity-history [this entity-id history-id datasource]
  ...
  (validate-list-entity-history [this id criteria sort-attrs from to datasource]
